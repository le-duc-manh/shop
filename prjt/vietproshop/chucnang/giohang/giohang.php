...
<form id="giohang" method="post">
        ...
        <tfoot>
            ...
            <tr>
                <td>
                    ...
                    <a href="#" onclick="document.getElementById('giohang').submit();" class="btn btn-info">Cập nhật giỏ hàng</a>  

                </td>
                <td colspan="2" class="hidden-xs"><a href="chucnang/giohang/xoahang.php?id_sp=0" class="btn btn-default">Xóa hết sản phẩm </a></td>
    ...
    <?php }
        ...
        echo '<script> alert("Hiện không có mặt hàng nào trong giỏ hàng của bạn")  </script>';
    } ?>
</div>
