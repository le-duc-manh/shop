...
// Phải chỉnh sửa lại
$mailer->Username = "nguavan997@gmail.com"; // GMAIL username
...
$mailer->AddCC("nguavan997@gmail.com", "Admin Vietpro Shop"); // gửi thêm một email cho Admin

// Chuẩn bị gửi thư nào
$mailer->FromName = 'Vietpro Shop'; // tên người gửi
$mailer->From = 'nguavan997@gmail.com'; // mail người gửi
